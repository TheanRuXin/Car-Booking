...
def search_cars(user_id):
    ...
    display_car_details(car_details, user_id)

def display_car_details(car_data, user_id):
    ...
    for i, car in enumerate(car_data):
        ...
        book_button = Button(
            ...
            bg="black",
            fg="white",
            command=lambda car_id=car['id']:open_booking_page(car_id, user_id)
        )
        canvas.create_window(x1 + 200, y1 + 130, anchor="nw", window=book_button, tags="car_detail")

def load_all_cars(user_id):
    conn = connect_db()
    cursor = conn.cursor()
...
if __name__ == "__main__":
    ...
    button_6 = Button(
        ...
        borderwidth=0,
        highlightthickness=0,
        command=lambda: search_cars(user_id),
        relief="flat"
    )
    button_6.place(
        x=102.0,

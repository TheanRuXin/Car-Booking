...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\User\Documents\Ruxin file\build\assets\frame6")
...
def sign_up_user(window):
    ...
    c.execute("SELECT * FROM Users_details WHERE email = ? AND password = ?", (email,password))
    ...
    c.execute("Insert INTO Users_details (username, phone_number, email, password) VALUES(?, ?, ?, ?)",(username, phone_number, email, password))
    conn.commit()
...
def show_sign_up_page():
    ...
    canvas.create_text(395.0,9.0,anchor="nw",text="Sign Up",fill="#000000",font=("Inter Bold", 55 * -1))

...
def show_history_details():
    ...
    cursor = conn.cursor()
    cursor.execute(''' 
        SELECT c.id,c.registration_number, c.make_and_model,
               h.rental_start_date, h.rental_end_date, h.total_price,
               COALESCE(julianday(h.rental_end_date) - julianday(h.rental_start_date), 0) AS days,c.image_path
        FROM History h
...
def open_rating_window():
    ...
    if hasattr(window, 'selected_car_info'):
        ...
        subprocess.Popen(["python", r"C:\Users\User\Documents\Ruxin file\build\build\rating.py", str(car_id), image_path])
    else:
...
button_1 = Button(image=button_image_1,borderwidth=0,highlightthickness=0,command=lambda:profile_button(window),relief="flat")
button_1.place(x=1126.0,y=31.0,width=49.0,height=49.0)

button_image_4 = PhotoImage(file=relative_to_assets("button_4.png"))
button_4 = Button(image=button_image_4,borderwidth=0,highlightthickness=0,command=lambda:promo_button(window),relief="flat")
button_4.place(x=854.0,y=24.0,width=90.0,height=52.0)

button_image_5 = PhotoImage(file=relative_to_assets("button_5.png"))
button_5 = Button(image=button_image_5,borderwidth=0,highlightthickness=0,command=lambda: cars_button(window),relief="flat")
button_5.place(x=784.0,y=24.0,width=70.0,height=52.0)
...
button_rating = Button(window, text="Rating", command=lambda:open_rating_window(), bg="red", fg="yellow",font=("KaiseiDecol Medium", 16 * -1))
